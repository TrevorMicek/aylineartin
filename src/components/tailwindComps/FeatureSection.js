...
export default function Example() {
  ...
  const LearnSection = () => {
    return (
      <>
      {learnMore ?  <p className="-mt-5 w-44 text-left text-gray-50 text-xs font-thin lg:mx-auto sm:text-sm md:text-base sm:w-60 md:w-72">
      ...
      :
      <>
      <p className="-mt-5 w-44 text-left text-gray-50 text-xs font-thin lg:mx-auto sm:text-sm md:text-base sm:w-60 md:w-72">
