...
return (
  <div style={{gridColumn:"span 7", gridRowStart:"fourth", gridRowEnd:"fifth", position: 'relative', zIndex:'12', top: '-2vh', zIndex: '21'}}>
      <img src={background} width="400px" height="200px" className="w-screen h-36 absolute " loading="lazy" />
