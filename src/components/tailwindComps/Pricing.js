...
export default function Example() {
  ...
  const LearnSection = () => {
    return (
      <>
      {learnMore ?  <p className="-mt-12 w-44 text-left text-gray-900 font-serif text-xs font-thin lg:mx-auto sm:w-60 md:w-72">
      ...
      :
      <>
      <p className="-mt-12 w-44 text-left text-gray-900 font-serif text-xs font-thin lg:mx-auto sm:w-60 md:w-72">
