...
<button className="w-52 mx-auto mb-4 bg-red text-black px-2 py-2 text-sm "><a href="https://aylineartin.bandcamp.com/album/heaven-in-hell-3">Buy Digital Album</a></button>
		</span>
		</div>
	)
}